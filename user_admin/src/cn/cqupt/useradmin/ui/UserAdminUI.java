package cn.cqupt.useradmin.ui;

import java.util.Properties;

import cn.cqupt.useradmin.io.IOUtils;
import cn.cqupt.useradmin.model.User;
...
public class UserAdminUI {
	...
	public void displayAddUserHelp(){
		System.out.println("添加用户的操作方法：add 用户 年龄 性别 薪水");
	...
	public void displayUpdateUserHelp(){
		...
		System.out.println("例子：Update id:5 salary=10000.00");
	}
	
	public void displayQueryUserHelp(){
		System.out.println("查询用户的操作方法：query id=id 或者 query name=用户名 或者 query salary>薪水");
